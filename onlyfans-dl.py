...
def api_request(endpoint, apiType):
    ...
    #print("Request Headers:", API_HEADER)
    #print("Request Params:", getParams)
    ...
    if status.ok:
        ...
        #print("Response Headers:", dict(status.headers))
...
#############################################
# Return empty list instead of None (START) 
#############################################
...
############################################
# Return empty list instead of None (END)  #
############################################
...
if __name__ == "__main__":
    ###############################################
    # ADDED NEW OPTIONS --list and --help (START) #
    ###############################################
    if "--help" in sys.argv:
    ...
    #############################################
    # ADDED NEW OPTIONS --list and --help (END) #
    #############################################
